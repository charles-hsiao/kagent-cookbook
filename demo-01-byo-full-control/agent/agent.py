...
This demonstrates that BYO agents give you 100% control over ADK configuration.
You can enable BuiltInPlanner, use any model, set any ADK parameter - things
that are NOT possible with kagent Declarative agents.

Usage: kagent-adk run agent --host 0.0.0.0 --port 8080
"""
import os
...
# root_agent is what kagent-adk CLI looks for
root_agent = Agent(
